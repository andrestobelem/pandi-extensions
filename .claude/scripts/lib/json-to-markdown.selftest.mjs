...
// 1) Array of uniform objects -> markdown table
const tableIn = {
  totalFrases: 36,
  coordinadas: 36,
  bucketsFallidos: 0,
...
// 2) Nested object -> key/value list, recursive with heading for big values
const kvIn = {
  name: "panda",
  active: true,
...
// 3) Array of primitives -> bullet list, with maxRows cap
...
// bonus: heterogeneous array -> numbered sections
...
// bonus: plain primitive passthrough
