/**
 * Durable behavioral e2e for ctx.workflow() composition in extensions/dynamic-workflows.ts.
 *
 ...
 *
 * Run it:
 *   node examples/e2e/dynamic-workflow-composition.e2e.mjs
 */
...
async function buildExtension() {
	const outDir = await fs.mkdtemp(path.join(os.tmpdir(), "pi-dwf-e2e-"));
