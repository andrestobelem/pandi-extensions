...
const plan = await agent(
	[
		...
		"MIRROR RULE (scaffolds): if extensions/pi-dynamic-workflows/scaffolds/*.js is edited, the generated mirrors under .claude/workflows/ and .pi/skills/ultracode/reference/claude-workflows/ MUST be regenerated via `node .claude/scripts/generate-claude-workflows.mjs` and included in filesToTouch — byte-parity is pinned by claude-parity.test.mjs, so stale mirrors turn VERIFY red.",
		"",
