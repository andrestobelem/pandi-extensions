...
Este directorio guarda el historial de trabajo, decisiones, workflows creados y conversaciones relevantes del proyecto.

## Índice

- [Memoria de trabajo](./memoria.md)
- [Plan: paridad con Claude Dynamic Workflows](./planes/2026-06-25-paridad-claude-dynamic-workflows.md)
- [Workflow: TUI Monitor-first + patrones Claude](./workflows/ejecutar-tui-monitor-claude.md)
...
- `docs/workflows/`: documentación técnica de workflows y ejecuciones.
- `docs/conversaciones/`: registro resumido de conversaciones y decisiones tomadas.
- `docs/investigaciones/`: notas de investigación, fuentes consultadas y decisiones de implementación.
- `docs/planes/`: planes y roadmaps de implementación con prioridades y dependencias.
- Cada documento debe incluir fecha, contexto, archivos afectados y próximos pasos.
