...
- Para tareas no triviales usamos dynamic workflows: subagentes paralelos o secuenciales, límites explícitos de recursos, y artifacts persistidos como evidencia.
