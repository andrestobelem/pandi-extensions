...
pi install git:github.com/andrestobelem/pandi-extensions@v0.3.18   # suite fijada para tu usuario
```
...
| ------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------ |
| Suite fijada para tu usuario    | `pi install git:github.com/andrestobelem/pandi-extensions@v0.3.18`    | Usá la suite estable completa en todos tus proyectos.        |
| Suite fijada para un proyecto   | `pi install -l git:github.com/andrestobelem/pandi-extensions@v0.3.18` | Solo ese proyecto debe cargar la suite estable completa.     |
...
| Canal                                     | Cómo                                                                                                | Cuándo                                                                                                                                                                                                             |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Bundle git fijado**                     | `pi install git:github.com/andrestobelem/pandi-extensions@v0.3.18`                                  | Consumo user-wide de toda la suite, con versión estable.                                                                                                                                                           |
