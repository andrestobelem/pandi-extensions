...
pi install git:github.com/andrestobelem/pandi-extensions@v0.3.19   # suite fijada para tu usuario
```
...
| ------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------ |
| Suite fijada para tu usuario    | `pi install git:github.com/andrestobelem/pandi-extensions@v0.3.19`    | Usá la suite estable completa en todos tus proyectos.        |
| Suite fijada para un proyecto   | `pi install -l git:github.com/andrestobelem/pandi-extensions@v0.3.19` | Solo ese proyecto debe cargar la suite estable completa.     |
...
| Canal                                     | Cómo                                                                                                | Cuándo                                                                                                                                                                                                             |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Bundle git fijado**                     | `pi install git:github.com/andrestobelem/pandi-extensions@v0.3.19`                                  | Consumo user-wide de toda la suite, con versión estable.                                                                                                                                                           |
