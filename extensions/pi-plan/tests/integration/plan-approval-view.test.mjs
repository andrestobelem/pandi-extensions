 ...
 * extensions/pi-plan/index.ts to a tempdir ESM (aliasing typebox + the SDK + pi-tui to local
 ...
 *
 * Run it:    node extensions/pi-plan/tests/integration/plan-approval-view.test.mjs
