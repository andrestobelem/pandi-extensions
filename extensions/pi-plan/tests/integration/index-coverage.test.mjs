/**
 * Durable CHARACTERIZATION suite for the still-uncovered seams of extensions/pi-plan/index.ts.
 *
 ...
 *
 * Run it:    node extensions/pi-plan/tests/integration/index-coverage.test.mjs
