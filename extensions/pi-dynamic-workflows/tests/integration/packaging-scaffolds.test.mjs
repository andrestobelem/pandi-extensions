 ...
 * via `readdirSync(SCAFFOLDS_DIR)` (extensions/pi-dynamic-workflows/scaffolds/*.js)
 ...
 *
 * Run directly:
 *   node extensions/pi-dynamic-workflows/tests/integration/packaging-scaffolds.test.mjs
 */
...
function main() {
	...
	const missing = scaffolds.filter((f) => !packed.has(`extensions/pi-dynamic-workflows/scaffolds/${f}`));
	check(
