 ...
 *
 * Run it:
 *   node extensions/pi-dynamic-workflows/tests/integration/agent-artifact-path-containment.test.mjs
 */
...
async function buildExtension() {
	return await sharedBuildExtension({
		...
		src: path.join(REPO_ROOT, "extensions", "pi-dynamic-workflows", "agent-view.ts"),
