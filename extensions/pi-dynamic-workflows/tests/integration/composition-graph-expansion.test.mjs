 ...
 * (`dynamic_workflow action="graph"`) of extensions/pi-dynamic-workflows/index.ts.
 *
 ...
 *
 * Run it:
 *   node extensions/pi-dynamic-workflows/tests/integration/composition-graph-expansion.test.mjs
 */
