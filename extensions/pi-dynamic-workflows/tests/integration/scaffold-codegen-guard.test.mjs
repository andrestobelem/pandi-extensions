 ...
 *
 * Mutation-free: reads extensions/pi-dynamic-workflows/scaffolds/workflow-factory.js
 * and pattern-matches; does not execute the workflow or call any agent.
 *
 * Run it:
 *   node extensions/pi-dynamic-workflows/tests/integration/scaffold-codegen-guard.test.mjs
 */
