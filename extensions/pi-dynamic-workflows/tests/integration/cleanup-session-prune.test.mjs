 ...
 *
 * Run it:
 *   node extensions/pi-dynamic-workflows/tests/integration/cleanup-session-prune.test.mjs
 */
...
async function loadModule() {
	const { url } = await buildExtension({
		...
		src: path.join(REPO_ROOT, "extensions", "pi-dynamic-workflows", "pi-session.ts"),
