...
```bash
pi install ./extensions/pandi-plan          # global (your user)
pi install -l ./extensions/pandi-plan       # project-local
pi --no-extensions -e ./extensions/pandi-plan   # one-off trial, nothing else loaded
```
