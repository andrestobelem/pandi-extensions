 ...
 * ---------------------------------------------------------------------------
 * It esbuilds the CURRENT extensions/pandi-plan/index.ts into an OS temp dir at run time (never a stale
 ...
 *
 * Run it:    node extensions/pandi-plan/tests/integration/plan-approval.test.mjs
...
// ---------------------------------------------------------------------------
// Build the current extensions/pandi-plan/index.ts to ESM in a temp dir, return import URL.
// ---------------------------------------------------------------------------
