 ...
 * extensions/pi-goal/index.ts that the sibling goal-rehydrate.test.mjs does NOT exercise.
 *
 ...
 * extensions/pi-goal/index.ts into an OS temp dir, aliasing the two external peer packages
 ...
 *
 * Run it:
 *   node extensions/pi-goal/tests/integration/index-coverage.test.mjs
 *
