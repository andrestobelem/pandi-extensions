/**
 * Durable behavioral integration test for the DURABILITY surface of extensions/pandi-loop/index.ts:
 ...
 * esbuild the CURRENT extensions/pandi-loop/index.ts into an OS temp dir at run time (never a stale
