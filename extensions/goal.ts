 ...
 *   the goal as `done`.
 * - Subagent mechanism mirrors extensions/dynamic-workflows.ts runSubagent: piCommand =
 ...
 *
 * AUTONOMOUS: this file does not import from extensions/loop.ts; patterns are copied.
 */
