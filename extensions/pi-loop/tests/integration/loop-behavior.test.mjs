/**
 * Durable behavioral integration test for the SCHEDULING ENGINE of extensions/pi-loop/index.ts.
 *
 ...
 * extensions/pi-plan/tests/integration/plan-gate.test.mjs and extensions/pi-loop/tests/integration/loop-safety.test.mjs. What had NO durable behavioral coverage is the
 ...
 * extensions/pi-loop/index.ts into an OS temp dir at run time (never a stale copy), alias the two peer
 ...
 *
 * Run it:
 *   node extensions/pi-loop/tests/integration/loop-behavior.test.mjs
