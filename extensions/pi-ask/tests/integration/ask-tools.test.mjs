 ...
 * extensions/pi-ask/index.ts: `ask_choice` and `ask_confirm`.
 *
 ...
 *
 * Self-bootstrapping: esbuilds the CURRENT extensions/pi-ask/index.ts into an OS temp
...
async function buildAsk() {
	return await buildExtension({
		name: "pi-ask-tools",
		src: path.join(REPO_ROOT, "extensions", "pi-ask", "index.ts"),
		outName: "ask.mjs",
		stubs: { typebox: true },
		npx: "--no-install",
	});
