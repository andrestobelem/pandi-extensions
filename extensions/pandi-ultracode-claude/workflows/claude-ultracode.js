/**
 * claude-ultracode — gateway read-only para una tarea libre invocada desde Claude.
 * El Contract Gate decide si alcanza una respuesta única; solo un routing dinámico abre fan-out.
 */
export const meta = {
	name: "claude-ultracode",
	description: "Router de Ultracode para Claude: contract-gate y ejecución read-only mínima.",
...
export default async function main() {
	...
	if (work.length < 2) throw new Error("Claude planning returned fewer than two independent work units.");
