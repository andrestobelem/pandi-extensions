 ...
 * Los setters de progreso/fin/error y el widget inferior viven en lifecycle/status; los call sites
 * internos importan desde lifecycle, no desde esta fachada.
 *
