 ...
 * its own skills when installed standalone (`pi install ./extensions/pandi-dynamic-workflows`).
 *
 * This pins:
 ...
 *
 * Run it:
 *   node extensions/pandi-dynamic-workflows/tests/integration/extension-skills-vendor-parity.test.mjs
 */
