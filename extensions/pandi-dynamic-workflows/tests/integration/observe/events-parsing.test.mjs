 ...
 *
 * Ejecutalo:
 *   node extensions/pandi-dynamic-workflows/tests/integration/observe/events-parsing.test.mjs
 */
...
async function buildExtension() {
	return await buildDwfExtension({ name: "pi-run-events-integration" });
}
