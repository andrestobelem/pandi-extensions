...
import type { WorkflowGraphFanoutInfo, WorkflowGraphFanoutUnit, WorkflowGraphModel } from "./workflow-graph-types.js";
...
export async function renderWorkflowGraphImage(
	...
	const { renderWorkflowGraphMermaidLines } = await import("./workflow-graph-render.js");
