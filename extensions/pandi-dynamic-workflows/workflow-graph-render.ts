...
import { workflowGraphStats, workflowGraphVisibleFanoutSlots } from "./workflow-graph-image.js";
import { buildWorkflowGraphModelWithSubworkflows } from "./workflow-graph-model.js";
import type { WorkflowGraphModel, WorkflowGraphRenderTheme, WorkflowGraphStep } from "./workflow-graph-types.js";
...
export async function showWorkflowGraph(
	...
	if (ctx.mode === "tui") {
		const { renderWorkflowGraphImage } = await import("./workflow-graph-image.js");
