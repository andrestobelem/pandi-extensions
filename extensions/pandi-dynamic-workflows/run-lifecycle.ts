/**
 * Workflow run lifecycle — background launch/resume plus run-status scaffolding and
 * result notification. Cancel/delete/cleanup/abort viven en run-lifecycle-cleanup.ts.
