/**
 * Resolución de workflows — descubrimiento de archivos de workflow entre ubicaciones project/global
 * (listWorkflows, resolveWorkflow). La incumbencia "dónde viven los workflows" separada del engine
 * que los ejecuta. Layout de paths/runs/graphs vive en `lib/paths.ts`.
 */
...
import { ensureDir, WORKFLOW_DIR, WORKFLOW_DRAFT_DIR } from "../lib/paths.js";
import type {
	WorkflowDefinition,
	WorkflowLocation,
	WorkflowRunRecord,
