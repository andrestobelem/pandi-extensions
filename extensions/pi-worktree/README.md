...
```bash
pi install npm:@pandi-coding-agent/worktree     # from npm

pi install ./extensions/pi-worktree             # from this repo, global
pi install -l ./extensions/pi-worktree          # from this repo, project-local
